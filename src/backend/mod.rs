//! The virtual machine takes bytecode generated by the front-end as instructions.
...
//! Each B-tree consists of many nodes. Each node is one page in length.
...
//! In this tutorial, I’m not going to support multiple platforms.
